...
//]
//let b405_labels = ["B405_Neutral", "B405_bypass_tray_Closed", "B405_bypass_tray_Open","B405_front_door_Closed", "B405_front_door_Open"]


//let anchors: [[Float]] = [[116,90,  156,198,  373,326], [30,61,  62,45,  59,119], [10,13,  16,30,  33,23]]
//
//let anchors: [Float] = [23.0, 27.0 ,37.0, 58.0, 81.0, 82.0]
